...
public class Player{
  ...
  public Player(int x, int y, int sizeX, int sizeY, int edgeX, int edgeY){  //modified michael, added images for animations- may17
    ...
    try
    {
      idleLeft = ImageIO.read(new File("Resources/Player/idleLeft.png"));
      idleRight = ImageIO.read(new File("Resources/Player/idleRight.png"));
      jumpLeft = ImageIO.read(new File("Resources/Player/jumpLeft.png"));
      jumpRight = ImageIO.read(new File("Resources/Player/jumpRight.png"));
