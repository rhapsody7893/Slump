...
public class Platform extends Obstacle{
  ...
  public Platform(int x, int y, int length){
    ...
    if (r == 1)
      try{setImage(ImageIO.read(new File("Resources/Blocks/darkstone.jpg")));}catch(IOException e){e.printStackTrace();}
    else if (r ==2)
      try{setImage(ImageIO.read(new File("Resources/Blocks/stone.jpg")));}catch(IOException e){e.printStackTrace();}
    else
