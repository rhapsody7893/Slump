...
public class MainWindow extends JFrame implements ExitListener, ActionListener {
  ...
  public void setup(Graphics g){
    try{
      BufferedImage image;
      if(alpha < 1f){
        image = ImageIO.read(new File("Resources/Screens/intro1.png"));
      }else
        image = ImageIO.read(new File("Resources/Screens/intro2.png"));
  ...
  public void paint(Graphics g){//Implemented paint, Feng May 10 30 min
    ...
    try {
      BufferedImage cave = ImageIO.read(new File("Resources/Screens/cave.png"));
      if(curScreen.equals("menu")){ //michael - added image and option May 17, 2019 5mins
        if (hover == 0)
          background = ImageIO.read(new File("Resources/Screens/Menu.png"));
        if (hover == 1)
          background = ImageIO.read(new File("Resources/Screens/menu1.png"));
        if (hover == 2)
          background = ImageIO.read(new File("Resources/Screens/menu2.png"));
        if (hover == 3)
          background = ImageIO.read(new File("Resources/Screens/menu3.png"));
        if (hover == 4)
          background = ImageIO.read(new File("Resources/Screens/menu4.png"));
        if (hover == 5)
          background = ImageIO.read(new File("Resources/Screens/menu5.png"));
        ...
        if (hover == 0)
          background = ImageIO.read(new File("Resources/Screens/Levels.png"));
        if (hover == 1)
          background = ImageIO.read(new File("Resources/Screens/levels1.png"));
        if (hover == 2)
          background = ImageIO.read(new File("Resources/Screens/levels2.png"));
        if (hover == 3)
          background = ImageIO.read(new File("Resources/Screens/levels3.png"));
        if (hover == 4)
          background = ImageIO.read(new File("Resources/Screens/levels4.png"));
        if (hover == 5)
          background = ImageIO.read(new File("Resources/Screens/levels5.png"));
        if (hover == 6)
          background = ImageIO.read(new File("Resources/Screens/levels6.png"));
        ...
        background = ImageIO.read(new File("Resources/Screens/Instructions1.png"));
        g2.drawImage(background, 0, 20, 811, 821,0,0,background.getWidth(), background.getHeight(), null);
        
        
      }else if(curScreen.equals("instructions2")){ //michael - added image and option  May 24, 2019 5 mins
        
        background = ImageIO.read(new File("Resources/Screens/Instructions2.png"));
        g2.drawImage(background, 0, 20, 811, 821,0,0,background.getWidth(), background.getHeight(), null);
        
      }else if(curScreen.equals("quit")){ //michael - added image and option  May 24, 2019 5 mins
        
        BufferedImage quit = ImageIO.read(new File("Resources/Screens/Quit.jpg")); //May 30, 2019, Michael Zhou added image
        
        int dialogButton = JOptionPane.YES_NO_OPTION;
        int dialogResult = JOptionPane.showConfirmDialog (null, "Are you sure you would like to quit?","Warning",dialogButton);
        if(dialogResult == JOptionPane.YES_OPTION){
          g.drawImage(quit, 0, 20, 811, 821,0,0,quit.getWidth(), quit.getHeight(), null);
          try{
            Thread.sleep(10000);
          }catch(Exception e){}
          dispose();
        ...
        background = ImageIO.read(new File("Resources/Screens/Highscores.jpg")); //May 30, 2019, Michael Zhou added image
        g2.drawImage(background, 0, 20, 811, 821, 0,0,background.getWidth(), background.getHeight(), null);
